...
const inspirations = [
  {
    type: 'verse',
    content: 'O son of Kuntī, the nonpermanent appearance of happiness and distress, and their disappearance in due course, are like the appearance and disappearance of winter and summer seasons. They arise from sense perception, O scion of Bharata, and one must learn to tolerate them without being disturbed.',
    source: 'Bhagavad Gita 2.14',
    image: null
  },
  {
    type: 'quote',
    content: "Life is nothing but a continuous quest for meaning. The consciousness of Krishna provides that meaning to the heart's longing.",
            ...
            <TabsContent value="darshan" className="mt-0">
              {inspiration.type === 'darshan' && inspiration.image && (
                <div className="space-y-4">
                  ...
                  />
                  <div className="p-4">
                    <p className="text-center font-medium">{inspiration.content}</p>
                    <p className="text-center text-sm text-muted-foreground">{inspiration.source}</p>
                  </div>
                </div>
              )}
            </TabsContent>
